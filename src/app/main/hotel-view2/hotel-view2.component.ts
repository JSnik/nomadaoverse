...
@Component({
  selector: 'app-hotel-view2',
  templateUrl: './hotel-view2.component.html',
  styleUrls: ['./hotel-view2.component.scss']
})
export class HotelView2Component  implements OnInit, AfterViewInit, OnDestroy{
  ...
  ngAfterViewInit() {
    ...
    const url = '../assets/new2/Main.gltf';
